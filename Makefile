...
SOURCES = $(PROGRAM:.bin=.c) i2c.c pwm.c
...
ASFLAGS = $(ARCH)
CFLAGS 	= $(ARCH) -g -Og -I$$CS107E/include $$warn $$freestanding -fno-omit-frame-pointer -fstack-protector-strong -fstrict-volatile-bitfields 
